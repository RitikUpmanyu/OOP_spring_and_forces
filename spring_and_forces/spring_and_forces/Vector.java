 ...
 *
 *
 * % java Vector x = (1.0, 2.0, 3.0, 4.0) y = (5.0, 2.0, 4.0, 1.0) x + y = (6.0,
 * 4.0, 7.0, 5.0) 10x = (10.0, 20.0, 30.0, 40.0) |x| = 5.477225575051661 <x, y>
...
public class Vector {
    ...
    /*
     * public Vector(double... data) { n = data.length;
     * 
     * // defensive copy so that client can't alter our copy of data[] this.data =
     * new double[n]; for (int i = 0; i < n; i++) this.data[i] = data[i]; }
     */
    ...
    public Vector unit() {
        ...
        c.data[0] = this.data[0] / Math.sqrt(Math.pow(this.data[0], 2) + Math.pow(this.data[1], 2));
        c.data[1] = this.data[1] / Math.sqrt(Math.pow(this.data[0], 2) + Math.pow(this.data[1], 2));
        return c;
    }
